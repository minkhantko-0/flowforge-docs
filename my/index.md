...
hero:
  name: FlowForge
  text: JSON Forms + Workflow Engine
  tagline: JSON Schema များဖြင့် form များကို တည်ဆောက်ပြီး workflow များနှင့် ချိတ်ဆက်ကာ ရှုပ်ထွေးသော approval process များကို custom code မရေးဘဲ လုပ်ဆောင်ပါ။
  actions:
    - theme: brand
      text: စတင်ရန်
      link: /my/guide/overview
    - theme: alt
      text: API အညွှန်း
      link: /my/reference/api

features:
  - icon: 📝
    title: JSON မှ Dynamic Forms
    details: JSON Schema နှင့် UI Schema ဖြင့် form များကို သတ်မှတ်ပါ။ Rating, slider, file upload စသည့် custom control များဖြင့် runtime တွင် render လုပ်ပါ။
  - icon: 🔀
